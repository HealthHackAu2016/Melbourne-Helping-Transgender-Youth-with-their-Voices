# This file calculated the parameters for score calculation from the sound .wav file--based on work by Kory Becker
...
specan3 <- function(X, bp = c(0,22), wl = 2048, threshold = 5, parallel = 1){
  ...
  fs <- list.files(path = "/home/bipin/Documents/voice-gender-master/chapter3", pattern = ".wav$", ignore.case = TRUE)
